...
- At least 10% above previous close, price at least $1, one million session shares.
...
substituted into the consolidated-volume strategy. The scanner falls back to
...
stops. Reports/intraday_backtest.json preserves hashes, daily returns, target hit
